...
public class Inmobiliaria implements Notificable {
	...
	public void agregarInmueble (Inmueble x) throws ArregloInmueblesLleno {
		if ( posicionInmueble (x) > -1 )
			throw new InmuebleYaEstaException( );
		if (cantidadInmuebles == maximoInmuebles)
			throw new ArregloInmueblesLleno( );
		if (inmuebles == null)
	...
	public void quitarInmueble (Inmueble x) {
		...
		else throw new InmuebleNoEncontradoException( );
	}
