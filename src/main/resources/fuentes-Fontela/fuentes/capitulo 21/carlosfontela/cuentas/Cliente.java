...
public abstract class Cliente implements Cloneable, java.io.Serializable {
	...
	public Object clone( ) throws CloneNotSupportedException {
		...
		((Cliente)copia).direccion = (Domicilio)this.direccion.clone( );
		((Cliente)copia).cuentas = this.cuentas.clone( );
		return copia;
	}
	
	public class Domicilio implements Cloneable, java.io.Serializable {
