...
public class TestFerreteria2 {
	...
	public void importeFactura() {
		assertEquals(factura1.importeTotal(), 1550.80, 0.01); // al comparar con 0.01, se permite un margen de error
	...
	public void stockInsuficiente() {
		try {
			...
			// tp1.modelo.StockInsuficienteException: No hay stock suficiente, quedan 3 pinza
		}
	}
