...
public class PruebaCuentas extends TestCase {
	...
	protected void setUp() throws Exception {
		super.setUp();
		juan = new Persona("Juan", "Perez", 5122122, "Lima", 444, "Belgrano", "Venezuela", "C1000AAA", "01140101010",
				"juan@perez.com.ar");
		ines = new Persona("Ines", "Garcia", 4011011, "Cerrito", 1111, "Santa Fe", "Arenales", "C1111ZZZ",
				"01140001111", "ines@garcia.com.ar");
		empresa = new Empresa("Luna Nueva S.A.", "1701234562", "Freire", 8888, "Dorrego", "Concepci�n Arenal",
				"C0000YYY", "01199991000", "info@tp1.empresa.com.ar");
