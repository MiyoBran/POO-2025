...
public class PruebaInmobiliarias {
	...
	public static void main (String[ ] p) {
		...
		Cliente joaquin = new Cliente ("Joaqu�n", "02234797152", "joaquin@mdp.com.ar");
		...
		Inmueble boyaca = new Casa("Boyac� 1244", 144.3, 5, 124300, true, true, false, 253);
		Inmueble artigas = new Departamento("Artigas 1366", 95.2, 3, 93700, false, true);
		Inmueble neuquen = new Departamento ("Neuqu�n 3455", 129.4, 5, 128400, true, true);
