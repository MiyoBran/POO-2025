...
public class PruebaInmobiliariasJUnit extends TestCase {
	...
	protected void setUp( ) throws Exception {
		...
		artigas.anotarInteresado(sucasa);
}
  ...
  // Prueba del metodo avisarRetiroVenta(inmueble x) , verificando los valores que retorna beneficioEsperadoCartera()

  public void testAvisarRetiroVenta( ) {
    // beneficio esperado antes de retirar un inmueble
    final double beneficiosMembrillar = 82000 * (0.06-0.01);
    final double beneficiosNeuquen = 128400 * (0.06-0.009);
    assertEquals (beneficiosMembrillar + beneficiosNeuquen,
          sucasa.beneficioEsperadoCartera( ), 1E-4);
    // retiro de un inmueble
    sucasa.avisarRetiroventa(membrillar);
    sucasa.quitarInmueble(membrillar);
    // beneficio esperado despues de retirar un inmueble
    assertEquals (beneficiosNeuquen,
          sucasa.beneficioEsperadoCartera( ), 1E-4);
  }
}
